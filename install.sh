#!/usr/bin/env sh
# Universal installer for cheatsense. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/cheatsense.git"
echo "Installing cheatsense ..."
